...
class Algorithm:
    ...
    def __init__(self, numberOfChromosomes, replaceByGeneration, trackBest, prototype ):
        ...
        # Deben existir por lo menos 2 cromosomas en la poblacion
        if numberOfChromosomes < 2:
            numberOfChromosomes = 2
                
        # el algortimo debe dar seguimiento al mejor cromosoma
        if trackBest < 1:
            trackBest = 1
        ...
        # Reservamos espacio para la población
        self.chromosomes = numberOfChromosomes * [None]
        self.bestFlags = numberOfChromosomes * [False]

        # reservamos espacio para el mejor grupo del cromosoma
        self.bestChromosomes = trackBest * [None]


    # Retorna referencia hacia la instancia global del algoritmo
    def GetInstance():
        # Generar protipo de los cromosomas
        print("get instance")
    ...
    def drawProfessor(self, qp):
        ...
        for i in range(0, GROUP_COLUMN_NUMBER):
            for j in range(0, GROUP_ROW_NUMBER):
                ...
                if j == 0 and i > 0:
                    days = ["LUN", "MAR", "MI", "JU", "VI"]
                    print("escribir texto")
